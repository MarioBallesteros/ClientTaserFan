...
public class CallMethods<T>  {
    ...
    private Retrofit retrofitCity = new Retrofit.Builder().baseUrl(Parameters.CITIES_URL).build();
    private APIService serviceCity = retrofit.create(APIService.class);
    ...
    public Response<ResponseBody> postCity(String url, RequestBody data){
